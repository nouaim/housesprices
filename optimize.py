...
print('best leaf nodes :', best)


model = DecisionTreeRegressor(max_leaf_nodes=best, random_state = 0)

model.fit(X, y)

print(model.fit(X, y))

### After we found the best tree size we can now train the model using the whole data
